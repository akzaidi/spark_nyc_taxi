...
```{r}
taxi_dir_hdfs <- paste0("/user/RevoShare/", your_name, "/nyctaxi")
system(paste0('hdfs dfs -mkdir ', taxi_dir_hdfs))
system(paste0("hdfs dfs -copyFromLocal data/ ", taxi_dir_hdfs))
```
