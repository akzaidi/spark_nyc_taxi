...
st <- Sys.time()
for(ii in 1:12) { # get each month's data and append it to the first month's data
...
#####################################################################
# 2.1a examining the neighborhoods
#####################################################################
...
res %>%
  mutate(tip_color = cut(tip_percent, c(0, 5, 8, 12, 15, 100))) %>%
...
#####################################################################
# 2.2c refactoring neighborhoods
#####################################################################
...
#####################################################################
# 2.2d trip distribution across neighborhoods
#####################################################################
...
#####################################################################
# 3.2a linear model predicting tip percent
#####################################################################
...
#####################################################################
# 3.2g judging predictive performance
#####################################################################
